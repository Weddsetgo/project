...
import 'package:weddsetgo/User%20Flow/screens/mybookings/cancelled_details/bookingmain.dart';

class PopularVendors5 extends StatefulWidget {
  const PopularVendors5({Key? key}) : super(key: key);

  @override
  _PopularVendors5State createState() => _PopularVendors5State();
}

class _PopularVendors5State extends State<PopularVendors5> {
          ...
          children: [
            InkWell(
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => PhotoScreen3()),
                );
              },
