...
import 'package:weddsetgo/User%20Flow/screens/mybookings/upcoming_details/bookingmain.dart';

class PopularVendors3 extends StatefulWidget {
  const PopularVendors3({Key? key}) : super(key: key);

  @override
  _PopularVendors3State createState() => _PopularVendors3State();
}

class _PopularVendors3State extends State<PopularVendors3> {
            ...
            InkWell(
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const PhotoScreen77()),
                );
              },
