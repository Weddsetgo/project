...
import 'earnings filter.dart';
import 'earnings transferred.dart';
...
class _PaymentCardScreenState extends State< EarningsScreen> {
      ...
      children: [
        ...
        Expanded(
         ...
         Expanded(
          child: Padding(
            padding: const EdgeInsets.all(16.0),
            child: Text('Transferred', style: textStyle),
          ),
        ),
        Expanded(
          child: Padding(
