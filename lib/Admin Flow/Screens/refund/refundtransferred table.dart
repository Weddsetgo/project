...
import 'refund popup2.dart';

class refundTransferred extends StatefulWidget {
  @override
  _refundTransferredState createState() => _refundTransferredState();
}

class _refundTransferredState extends State<refundTransferred> {
              ...
              showDialog(
                ...
                builder: (BuildContext context) {
                  return AlertDialog(
                    ...
                    content:
                        RefundPopup2Card(), // Replace with the widget you want to show in the popup
                  );
                },
              );
            },
