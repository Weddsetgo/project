...
import 'package:weddsetgo/Admin%20Flow/Login%20Page%20Admin/submit_admin.dart';

class ForgetAdmin extends StatefulWidget {
  const ForgetAdmin({super.key});

  @override
  State<ForgetAdmin> createState() => _loginState();
}

class _loginState extends State<ForgetAdmin> {
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const SubmitAdmin()),
                            );
                            //  }
                          },
