...
class ComplaintGeneralTable12 extends StatefulWidget {
  const ComplaintGeneralTable12({super.key});

  @override
  _EarningTableScreenState createState() => _EarningTableScreenState();
}

class _EarningTableScreenState extends State<ComplaintGeneralTable12> {
