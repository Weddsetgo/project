...
class EarningsDrawer extends StatefulWidget {
  @override
  _EarningsDrawerState createState() => _EarningsDrawerState();
}

class _EarningsDrawerState extends State<EarningsDrawer> {
